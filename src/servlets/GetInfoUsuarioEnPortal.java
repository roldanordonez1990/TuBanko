 ...
 */
@WebServlet("/GetInfoUsuarioEnPortal")
public class GetInfoUsuarioEnPortal extends SuperTipoServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (accion != null && accion.equals("almacenar")) {
				...
				u.setTipologiasexo((Tipologiasexo) TipologiaSexoControlador.getControlador().find(rootNode.path("idTipologiaSexo").asInt()));
