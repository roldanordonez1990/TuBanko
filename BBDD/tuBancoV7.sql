...
--
-- Table structure for table `tipologiasexo`
--

DROP TABLE IF EXISTS `tipologiasexo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tipologiasexo` (
  `id` int NOT NULL,
...
--
-- Dumping data for table `tipologiasexo`
--

LOCK TABLES `tipologiasexo` WRITE;
/*!40000 ALTER TABLE `tipologiasexo` DISABLE KEYS */;
INSERT INTO `tipologiasexo` VALUES (1,'Hombre'),(2,'Mujer'),(3,'Otro');
/*!40000 ALTER TABLE `tipologiasexo` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `usuario` (
  ...
  KEY `fk1` (`idTipologia`),
  CONSTRAINT `fk1` FOREIGN KEY (`idTipologia`) REFERENCES `tipologiasexo` (`id`),
...
INSERT INTO `usuario` VALUES (1,'Rafa ','1234','rafa@rafa.com',1,'Munoz','50514382T','Calle Encinas',111222333,1);
...
-- Dump completed on 2020-06-04 13:06:15
